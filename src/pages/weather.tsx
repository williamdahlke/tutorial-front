        ...
        <form className="border-2 border-black rounded-md p-2 m-2 bg-slate-500 flex flex-col">
          ...
          <div className="flex justify-between gap-2">
            ...
            <input
              className="border-2 border-black rounded-md"
              type="number"
              value={weatherData.numberOfDays}
              onChange={(e) => {
                setWeatherData((prev) => {
                  return {
                    city: prev.city,
          ...
          <button
            type="submit"
            className="border-2 border-black p-2 rounded-md bg-slate-200 mt-4"
      ...
      {fetchedWeatherData && !fetchedWeatherData.error ? (
        <div className="mt-4 border-2 border-black rounded-md p-4 bg-white flex flex-col justify-center gap-4">
          <div>
            ...
            <img
              src={fetchedWeatherData.current.condition.icon}
              alt={""}
              width={50}
              height={50}
            />
          ...
          <span>
            Hora e data local: {fetchedWeatherData.location.localtime}
          </span>
